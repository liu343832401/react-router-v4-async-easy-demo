...
import { Checkbox, DatePicker, InputItem, List, Picker } from 'antd-mobile'
  ...
  render () {
    ...
    return (<form className="form" onSubmit={ () => { return false } }>
      <List renderHeader={ () => <b>表单项</b> }>
        ...
        <Picker extra="请选择(可选)" data={ district }
      ...
      <Picker data={ district } title="选择地区" extra="请选择(可选)"
              value={ pickerValue }
              onChange={ (v) => this.setState({ pickerValue: v }) }>
        <CustomChildren>省市区选择</CustomChildren>
      </Picker>
      <DatePicker mode="date" title="选择日期" extra="请选择(可选)" value={ dpValue }
